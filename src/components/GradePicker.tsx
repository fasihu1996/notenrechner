...
export default function GradePicker({ course, onGradeChange }: GradePickerProps) {
    ...
    const placeholder = course.graded ? "Wähle eine Note..." : "Wähle Bestanden/Nicht bestanden...";
